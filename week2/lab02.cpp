...
/*
 * Sample interaction
cout << "What is your horizontal velocity (m/s)? " << endl;
cout << "What is your vertical velocity (m/s)? " << endl;
cout << "What is your altitude (m)? " << endl;
cout << "What is the angle of the LM where 0 is up (degrees)? " << endl;

cout << "For the next 5 seconds with the main engine on, the position of the lander is:  " << endl;

 cout << "1s - x,y:(3.87, 89.80)m  dx,dy:(2.58, -10.14)m/s  speed:10.46m/s  angle:60.00deg" << endl;
